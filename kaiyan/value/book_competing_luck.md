...
# 5.generate ideas and plan your roadmap
...
# 2.disruptive /dɪsˈrʌptɪv/ innovation [phr.颠覆性创新]
> it means innovations that essentially change the market.

# 3.predictive [adj.] &  predictive text
> 1)this is growth that you can count on,it's going to happen because you can predict it.

> 2)a lot of computers or phones,they have predictive text algorithms[n.算法].so they know what you're going to text next. 
...
# 4.sinks or floats/sink or swim [n.成败]
> 1)sinks or floats here just means fails or succeeds.

> 2)this is actually similar to "sink or swim".it means your success is up to you.

# 5.gaining traction [phr.(产品等）变得流行]
> gaining traction is all about gaining popularity and that staying power that really drives your product.if you don't have any traction,you are just going to be stuck in one place.if you're in a car,your tires will be spinning,but you will not be moving,so you obviously will not be succeeding in that sense.
...
# 6.reframing [ptcp.重构]
> wo don't only need to use this word in business,or when talking about pictures,you can "reframe" lots of things,like reframing your mindset.

# 7.pinpointing /ˈpɪnpɔɪntɪŋ/ [v.准确指出，确定]
> people use it to indicate a specific location,we could pinpoint the cause of the company's failure or pinpoint a company's reason for growth.

# 8.causal mechanisms [n.因果机制]
> "causal mechanisms" are essentially those drivers that motivate us to do sth.

# 9.harness /ˈhɑːrnəs/ [v.利用] & harnessing knowledge/solar power 
> so a harness is sth you put on a horse and it helps you to control that horse.

# 10.hone in on [phr.专注]
> it means really focus on this,so as you're analyzing the situation and the experience.

# 11.friction 
> so the friction is basically the obstacle or problems that inhibits sb from buying his.
