...
## 1)nip ths problem in the bud
> This idiom means that a problem should be dealt with early before it becomes a bigger problem. A "bud" is a flower in its early stage of growth, before it has opened up. If we "nip a flower bud," that means we cut the bud before it has a chance to grow larger. This is where the idiom comes from.
...
> a perfectionist that's sb who's not happy unless everything's perfect,unless they do everything perfectly.the idea here is that if you're a "perfectionist",you want evertthing to be 

# 7.rectify [纠正；矫正；改正]


# 8.low-priority [不重要的，优先级低的]

# 9.instant gratification [即时满足]
...
# incentivizing /ɪnˈsent̬əvaɪzɪŋ/ 激励
