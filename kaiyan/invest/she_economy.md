...
# 2.substantial /səbˈstænʃəl/ [adj.大量的,重要的] & marginal [adj.]
...
# 3.fueling /ˈfjuːəlɪŋ/ [ptcp.加强] & driving 
...
# 4.empowerment /ɪmˈpaʊɚmənt/ [n.赋权] & empowered [adj.] & clout /klaʊt/ [n.影响力]
> 1)empowerment means to give sb power.you can empower people with knowledge or opportunities.

> 2)people who have received money,education and have many opportunities are "empowered".
...
> 3)women having more clout in society and companies possibly considering hiring more women to tap into the female perspective.

# 5.tap /tæp/ into [phr.发掘、进入；利用] & C-suite [企业高管层,如CEO、CTO、COO] & level the playing field [phr.创造公平竞争环境]
...
> 3)these are all the people at the top,but it's kind of long to say executives or to list all the different Cs,so we just say C-suite.

> 4)so often you need to level the playing field for markets,and that often means making things more fair for companies.it could be a very theoretical approach.
