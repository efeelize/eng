...
# 15.policy
> Basically they could be rules about behaviour or they could be other kind of company rules. So for example, when you go buy something from a store, they usually have some kind of return policy.And policies also can be kind of principles as well. So maybe you have personal policies about how you should behave.Exactly, and that's what this is all about, how you should behave, how you should dress. I mean they want them to express their personal style, be fashionable, but you know, as long as it's within reason.

# 16.keep it within reason[phr.合理的]
> So it's within reason, it means like within a reasonable range.Yeah. Not too much, not too extreme. Don't cross the line.For sure, for sure. And a lot of ladies want to go on a diet too, right? But they should really go on a diet within reasons. Yeah, so don't like starve your self for anything.
> Oh, and the verb we often use with this phrase is "keep". Keep it within reason.

# 17.cutting edgy /'ɛdʒi/ /edgy[前卫]
> Oh, yeah, edgy. So edgy, it's just sort of like unusual, it's sort of like fashion forward, I guess.

> Yeah, for sure[adv. 确实]. You guys might have heard the expression cutting edge as well[也，强调时可放在句中] when we talk about technology, right? That's the very new technology that's coming out. But with fashion we don't really say cutting edge so much. I mean, actually sometimes we do, but it's more common to say "edgy".Ok, and the reason Jason says, you know, nothing too edgy is, cause you know, sometimes edgy fashion can make people uncomfortable.Yeah, because, I mean, it's the stuff that you can see on catwalks[T台]. It's not really the kind of stuff that you would wear to, I don't know, your everyday office.

# 18.revealing [adj.暴露的]/reveal[v]
> Revealing means that it's showing to much skin.

> And it comes from the verb "reveal", which means to show.To show, to show something that was covered or, or hidden.Yeah, I could also say that his behavior was very revealing of his opinion.Oh, exactly. You showed your true colors[本性].

# 19.roll into work
> So roll into work, to roll in, it just means arrive, but it has a really casual sense to it, right?Yeah, and often you're arriving a little late.Yes, so it is a chunk[???] and we often use it in these specific situations when you arrive late, like you said, "I rolled into work at eleven a.m. because I slept in."

> Yeah, or as you said casually as well, so you could roll into work wearing gym shorts and maybe you roll into work, maybe in your pajamas.

# 20.sleeveless[n.无袖上衣]
> Right, so sleeveless are usually those shirts that men wear or women wear when they're exercising.Yeah, the muscle shirts or tank tops.
