...
# I.handling a bad performance review rating
> A performance review or appraisal is not the end product of a negotiation between assessor and assessee. A performance appraisal is a formal record of a supervisor’s opinion of the quality of an employee’s work.

> The important word here is opinion. As long as that opinion is based on your manager’s honest assessment of how well you have done the job and is uncolored by personal biases and prejudices, the manager has done the job that is expected of them, and the matter is settled.

> When deciding whether to challenge a low rating, you’ve generally got three choices:1)“My boss may well be right. I’m disappointed, but I’m going to accept this and make whatever changes that are necessary to justify a higher rating next year.”2)“Damn the torpedoes! Full speed ahead! This rating is wrong, and I’m ready to do whatever it takes to get it changed.”3)“I’m out of here.” 

> When you do get back to your boss, do one of two things.1)Acknowledge that the assessment served as a significant learning experience (or wake-up call), and ask for their help in understanding how you can make a more valuable contribution in the next 12 months. 2)Tell your boss that you have considered the appraisal carefully, and after serious thought you believe that an adjustment of the rating is justified. Produce the evidence and the examples that justify your position, keeping in mind that success — a changed rating — is probably unlikely, regardless of your evidence. 

# II.grammar
# 1.I couldn’t help (but) + v./ + reflexive /rɪ'flɛksɪv/ pronoun [n.反身代词].
...
> 2)By saying “I couldn’t help but notice,” you are showing that you were not actively looking for this person’s mistakes.The phrase “I couldn’t help but notice” can be used to politely bring up a problem. For example, “I couldn’t help but notice that your reports have been a bit late.”

> 3)It’s possible to omit “but” and say “I couldn’t help + verb-ing” (e.g, I couldn’t help noticing). However, adding “but” makes it more polite and formal.

> 4)We can also say, “I couldn’t help + reflexive pronoun.” This means that the person has no control over themselves. (I couldn’t help myself! I ate the entire box of cookies.)
...
> 1)it is used to introduce a specific person or thing that helps explain a statement. It has a very similar meaning to "For example."
...
# 3.hence
> it means "therefore", but is used to give a reason or explanation for something that the listener/reader might have been wondering, but didn’t ask specifically. It’s another way to say "that’s why…."
...
## 2)workload [n.工作量]
> It just means you know how much work you're getting, how much work you have to do. so you could have a heavy workload—you can have a lot of work to do—or a light workload.

## 3)timeline [n.时间线、时间表] & schedule 
> It's just the schedule or plan.We often use it when we're asking how much time sth will take, like "What's your timeline?"or you might ask someone to make more detailed timeline.And verbs we use with this, you can provide a timeline. But timeline can be too short, so you need to make it more detailed. 

## 4)establish/maintain communications 
> 1) So when you establish communications that means that you're setting it up, you're making it known that they can communicate with you, that they can contact you and talk to you.

> 2) maintaining in its basic definition means to make sure that it stays good, so you can maintain your car, make sure that your car doesn't have any problems, or maintain a relationship with a good friend that you guys are both happy with your relationship.And when you want to maintain sth that means that you want to continue having sth, so you want to maintain their business that means that you want them to continue buying your product or service.

## 5)keep the lines of communication open with sb [n.交流方式]
> So these lines are communication, they're just the connection that you have between you and the customer, between the business and the customer. So they need to be open, the customer needs to be able to communicate with you.

# 5.performance related words
## 1)feedback & positive / constructive feedback [n.建设性的反馈]
> 1)"feedback.",these are the responses that you get from your boss about how you're doing. these are the criticisms about you. This is just opinions. like you did a good job. You did a bad job. This is all feedback. if I do some work, I usually ask somebody else for feedback. Just "What you think about this, is it good? Is it bad? Tell me how to make it better."so you could also get customer feedback, Like companies, in order to make their product better, they need to get feedback. They need to get the opinions of the customers.
...
## 2)perform well /poorly & high-performance 
> 1)So that's when at like the end of the year, they look over how well you did at work.many companies have performance reviews. A performance review talks about how well a person, an employee is performing. How well they're doing. 
...
## 3)the rating sacle 
> the rating scale is like,number five means that you are meeting and exceeding all of their expectations. And then number one is the opposite that you're not meeting or exceeding any expectations and you need to work on improving.

## 4)meeting/exceeding expectations 
> So expectations are things that you're supposed to do at your job, what your boss tells you to do and when you meet them that means that you're doing all those things.When you are exceeding them that means that you're doing them and you're doing more, you're going above and beyond what your supposed to do.
...
> So this is the way that performance evaluations usually work. You get a piece of paper that has different categories, and you rate yourself first. 

# 6.career related
## 1)biannual [adj.一年两次]
> biannual means that it's twice a year, so they do these performance evaluations twice a year.

## 2)move up the corporate ladder [phr.职业晋升]
> corporate ladder is the path from a beginning position at the company to a really high position.So we talk about a ladder, a ladder is, of course, something that you walk up to go from a low place to a high place. See you started at the bottom and then you slowly go to the top.
...
## 4）hoop to jump through [phr.繁琐的步骤] 
> it means something you have to do, it's part of your job. but it's at least annoying. Like the hoops would be things like  I need three copies of this form, this form needs to be on six different kinds of paper with twelve different colors, like that. Those would be the hoops.

## 5）jump through a hoop 
> jumping through a hoop is pretty easy to do.Like a hoop is a very big circle, and where this comes from is the circus,get the lion to jump through the hoop for some. 

## 6）red tape /tep/ [n. 繁文缛节] & cut red tape
> red tape is like restrictions. You can't do it because there is a restriction. Usually the red tape is put by administrations or management.like if a restaurant wants to sell liquor, sell beer or wine, they have to apply for a liquor license and there're something to a lot of red tape.

# 7.capacity related
## 1)competent [adj.有能力的] & incompetent
> It is is a kind of a formal word.When we're talking about being competent, we're talking about your skills or your ability at the job.We don't use it a lot in our day-to-day speaking, but if you're in a workplace, it's okay to use it.

## 2)good/bad fit [n.合适的人]
> 1)We usually hear this phrase when we're talking about clothes. "Does it fit? Is it the right size?" 

> 2)This is a really good phrase at a company. And it is kind of a set phrase. For example, we don't say, he doesn't fit well. We usually say he is not a good fit, If they're not a good fit, we can just say, "he's a bad fit" or "they are a bad fit."

## 3)productive [adj.] & productivity [n.]
> 1)It just means that you are good at making things.It comes from the verb to produce.

> 2)A lot of apps on my phone, are like productivity apps. for making me more productive like a to-do list or an organizer or schedule or calendar. 

## 4)bottom line [n.底线、最重要的事]
> This could be used in all kinds of different situations, like if you're doing a project and there are so many complicated details and finally your boss says the bottom line is we don't have enough money. Or say you're traveling, but you have so many things to do, but you just need to get to this one city, so you can say the bottom line is I need to get to where I'm going.But the bottom line is we don't have enough time.

## 5)lack sth
> Usually we use "lack" more when we're talking about our personality. It is kind of a more formal word.We use it more when we're talking about ourselves or someone else in a formal way.But if it's like an item like milk or sugar, we wouldn't use lack. We just say "I don't have..."or I'm out. 

## 6)interpersonal skill [n.人际交往能力] & anti-social
> 1)So anything that involves two people talking about things they need to get done at work. So it could be ways of disagreeing, or you know having a discussion. It could include skills for compromising, for persuading someone,problem-solving skills as well.Or anything that involves communication between different people. 
...
## 7)thorough /'θɝo/ [adj.详细的、细致的] & thoroughly [adv.]
> If you are thorough,  it means you're careful, you look at all the details and you don't make any errors.

## 8）deficiency /dɪ'fɪʃənsi/ [n.缺陷] & weakness & flaw & shortcoming 
> 1）a deficiency is a fancy way to say weakness.but "defficient" sounds very technical, like a machine. You have to set some kind of deficiency in the machine or the system.There's something lacking in it, often we can say a person has a vitamin /'vaɪtəmɪn/ deficiency.
...
> It means to the point, making it concise, in a nutshell /'nʌtʃɛl/ [概括].

## 10）ramble on about sth [phr.啰嗦闲谈] & drone /dron/ on [唠唠叨叨地说]
...
> 1)so the employee is getting abundant feedback, They're getting lots of feedback.

> 2)so it should be honest, candid, honest, frank and constructive. It should help you improve.

> 3)so sth is constructive, it's not just criticizing you, it's telling you how you can improve.

## 12）equitable /ˈɛkwɪtəbəl/ [adj.公平的] & equality /ɪ'kwɑləti/ [n. 同等,平等] & equal [adj.相同的]
> 1)equitable means fair.
...
> 1）implement means to put something into practice, to start something.start using it. So often you have something that's a little bit complicated, like a system or something, you need to implement it. we often say implement instead of just use or do, It sounds more sophisticated.

> 2) actionable is really just practical.it's sth you put into action.if you look at the dictionary, it's from like legal systems, law courts. And now we just use it in business a lot.

## 2）to clarify [v.澄清、确认、说明] & clarification [n.]
> "To clarify" means to make it clear, to explain sth that might be confusing.for example, if you're in a meeting you could say, "Could you clarify that? I didn't quite understand."

> 2)This is a pretty polite word. "Thanks for the clarification." it's kind of similar to that phrasal verb "clear up."

## 3）renewal /rɪ'nuəl/ [n.重建;更新] & renewal rate & renew [v.]
> 1)when we talk about renewal, we talk about sb signing up for sth again. Or if you're talking about a product, a customer buying the product again, if they renew, then that means that they continually try to buy this product.

> 2)So renewing is the verb to do sth again.

## 4）teach & coach
> 1)"Teach" just sounds just telling him how to do it.And teaching in my mind makes me think you teach them once and it's over.
...
## 5）rep [n.代表] & a sales/customer service rep
> 1)"rep" is just short for "representative." 

> 2)if you call, for example, an airline to change your plane ticket, you will talk to a customer service rep which is kind of like a company agent.So you could say, "customer service agent."

## 6）bring it/sth up with sb [phr.提起、提及]
> 1) it's usually just for things that we need to talk about. Like if you're with a girlfriend or boyfriend and you have some troubles in a relationship, you need to bring those up and talk about them before they explode into a big disaster.
...
## 5)regarding/in regards to & concerns 
> 1)So "regarding" just means "about," kind of "related to this." Or when you start a job, you might have questions regarding your pay.It can also be used to introduce something. For example, maybe in an email I write, "Hey, regarding the budget, we need to spend less money."

- I wrote an email regarding my new car.

> 2)Now you could also say "in regards to," but that is more formal.

> 3)it's a little more polite and maybe not as worried as the word "worry,"if we're ever worried about sth you can just say, "I'm having concerns about..." And then you can say what it is you're worried about.Or if you're feeling sick, you could say, "I'm having concerns about my health."

## 6)accordingly [adv.相应的]
> this just means the correct way or appropriately,or following this schedule. Maybe you have to dress according to that dress code. You have to dress accordingly. Or if someone goes to dinner at a guesthouse, they have to act accordingly. They have to behave well.you have to be polite. 
...
- they need to figure out the manager's goals and expectations are aligned with the subject's.

# 11.compile /kəm'paɪl/ [v.汇集]
> They can put it all together. They can aggregate it, and give out the report to the employee. put in the format that is pretty easy to understand,So you compile it, make the report.
