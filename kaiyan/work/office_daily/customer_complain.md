...
# 2. shoudn't we be giving 
> The truth is that native speakers love to use progressive tenses. In many cases they sound less direct than simple ones [进行时态在许多情况下，听起来比一般现在时要委婉], which is why we often say things like "I was wondering" and "I was thinking" instead of "I wonder" and "I thought." And even though Randy is asking a legitimate question here, he could also use this same pattern to offer suggestions to other people.

> If you don't use a progressive tense here, don't worry. You're not committing some terrible infraction.Remember, there are often many ways to express the same thing in English.

- 1. Shouldn't we be taking the highway? Wouldn't it be faster?[我们不应该走高速公路吗？那样不是更快吗?]

- 2. Shouldn't we be discussing this?[我们不应该讨论这个吗？]

- 3. Shouldn't we be bringing Jim into this discussion? Wouldn't he know what to do?[我们难道不应该让Jim参与到这场讨论中来吗？他知道该怎么办吧！]

# 3.programs
## 1)implementing /ˈɪm.plə.menɪŋ/ [v.实施]
...
- 4. The city plans to implement a host of measures to combat uncivilized behavior.[该市计划实施一系列措施以打击不文明行为]

- 5. Recent events have forced us to implement new policies regarding remote working.[最近的事件迫使我们实施有关远程工作的新政策]

- 6. Their policy was a good one, but the implementation was anything but.[他们的政策是好的，但实施却并不理想]

## 2)identify pain points [v.辨别出痛点]
...
## 3)frame question/conversation/narriative [v.设计、预设]
...
## 4)clouded our judgment [phr.干扰判断] & digging into [phr.深入研究]
...
## 5)portfolio /ˌpɔːrtˈfoʊlioʊ/ [n.组合]
...
- 3. We were granted exclusive rights to license and sell the product in our country.[我们被授予在我国独家授权和销售该产品的权利]

# 4.evaluate & measure & assess [v.评估] & commit [v.投身于]
> 1)you're kind of weighing your options.

> 2)basically it means to stick to sth.decide to do it for a while.

# 6.properly /ˈprɑːpɚli/ [adj.恰当的]
...
***Not all customers are created equal, nor is their level of loyalty. If you want to optimize your program, you need to segment your customers better.***

***That's where the "detractors," "passive" and "promoters" distinction of NPS comes in, right?***

***Exactly. Each type of customer values different things. For example, detractors and passives both tend to see value in price discounts.***

***But shouldn't we be giving the highest discounts to the promoters?***

***Price doesn't really incentivize promoters. For them, you can best add value by offering them nonmonetary perks.***

***Kind of like what Amazon does with its Prime program right?***

***Exactly. It gives customers tons of value-added services like free upgrades, exclusive content, and extra-fast shipping.***

***Well if it's good enough for Amazon, it's good enough for us. Let's get started!***
